...
public class Messages {// applicationumuzdaki tum messagelerimizi burda olusturucaz. Burdan alip kullanicaz.
    // final keyword oldugu icin tum degisken isimleri buyuk yazilir. final ve static oldugu icin enum yapisi gibi.
